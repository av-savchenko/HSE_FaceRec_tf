# This code is an adapted version of the file from the following project: https://github.com/dandynaufaldi/Agendernet/blob/master/model/insightface.py
...
class InsightFace:
    def __init__(self):
        ...
        model_path='D:/src_code/DNN_models/age_gender/insightface/gender-age/model/model,0'
        #model_path='D:/src_code/DNN_models/age_gender/gamodel-r50/model,0'
        self.ga_model = get_model(ctx, self.image_size, model_path, 'fc1')
        self.threshold = 1.24
        self.det_minsize = 50
